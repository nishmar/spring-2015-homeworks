...
def parse_hotellist_page(html, writer):
    ...
    Writes a new row to CSV file for each hotel.
    ...
    writer: csv writer object
    	Writer object for CSV file with hotel information.
    ...
    for hotel_box in hotel_boxes:
		...
		hotel_info_list = get_hotel_info(hotel_url)
...
def get_hotel_info(hotel_url):
	...
	Returns
	-------
	hotel_info_list: list of str
		Information scraped about hotel
	"""
	hotel_info_list = []
...
def scrape_hotels(city, state, datadir='data/'):
    ...
    with open(filename, "w") as output_file: 
        ...
        while(True):
        	c +=1
        	html = get_hotellist_page(city_url,c, city)
